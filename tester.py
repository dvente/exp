...
answer = check_output("./interpreter < expression.txt", shell=True).decode("utf-8")
...
target = check_output("./interpreter < expression.txt", shell=True).decode("utf-8")
